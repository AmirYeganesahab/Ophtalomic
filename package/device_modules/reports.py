...
class PurkinjeReport(QWidget):
    ...
    def initUI(self,x_direction:int,y_direction:int):
        ...
        self.glayout.addWidget(self.vpbartop,0,5,alignment=Qt.AlignCenter)
        ## write_log(get_linenumber())
        #bottomvertical
        ...
        self.glayout.addWidget(self.vpbarbottom,10,5,alignment=Qt.AlignCenter)
        ## write_log(get_linenumber())
        #tophorizontal
        ...
        self.glayout.addWidget(self.hpbarright,5,10,alignment=Qt.AlignCenter)
        ## write_log(get_linenumber())
        #bottomhorizontal
        ...
        self.glayout.addWidget(self.hpbarleft,5,0,alignment=Qt.AlignCenter)
        ## write_log(get_linenumber())
        self.fill_value()
        ## write_log(get_linenumber())
